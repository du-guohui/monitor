(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('mpvue-router-patch')) :
    typeof define === 'function' && define.amd ? define(['mpvue-router-patch'], factory) :
    (global.MpvueRouterPatchInterceptor = factory(global.MpvueRouterPatch));
}(this, (function (MpvueRouterPatch) { 'use strict';

    MpvueRouterPatch = MpvueRouterPatch && MpvueRouterPatch.hasOwnProperty('default') ? MpvueRouterPatch['default'] : MpvueRouterPatch;
    ...
    */
    ...
    return MpvueRouterPatchInterceptor;
